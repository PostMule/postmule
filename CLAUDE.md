...
- Brand reference: `postmule/web/templates/postmule_brand_03_final.html` | Living mockup: `docs/mockup_dashboard.html` (keep in sync; published at https://postmule.github.io/app/mockup_dashboard.html)
